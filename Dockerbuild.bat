...
docker buildx build -f Dockerfile --platform linux/amd64,linux/arm64/v8 --tag jchristn/litegraph-ui:%1 --load .

IF "%2" NEQ "1" GOTO :Done

ECHO.
ECHO Pushing image...
docker push jchristn/litegraph-ui:%1
...
ECHO Example: dockerbuild.bat v1.1.0 1
